...
class PlanetFactsViewController: UIViewController, UITextFieldDelegate, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        } else if(self.categoryTitle! == "Detailed Planet Statistics") {
...
//        planetImageView.layer.masksToBounds = true
        ...
        compositionTextView.backgroundColor = UIColor(red: 0.0/255.0, green: 102.0/255.0, blue: 153.0/255.0, alpha: 0.5)
        ...
        if UIScreen.mainScreen().bounds.size.height == 320 {
            ...
            compositionTextView.font = UIFont(name:"AvenirNextCondensed-DemiBold", size:12.0)
            compositionTextView.frame = CGRect(x: 10, y: 45, width: informationView.frame.size.width - 20, height: (informationView.frame.size.height/10)*8 - 20)
